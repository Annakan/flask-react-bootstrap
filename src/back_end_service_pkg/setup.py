...
setup(
    ...
    version=VERSION,
    # (...)
    description="Flask+ React + SocketIO Python 3 Demo backend_service",
    ...
    entry_points={
        'console_scripts': ['zmqserver_run=backend_service.console:zmqserver_run',
                            'zmqclient_run=backend_service.console:zmqclient_run',
                            ],
    },
    author='X³',
    author_email='',
